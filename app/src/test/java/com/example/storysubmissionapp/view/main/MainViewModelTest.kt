...
import com.example.storysubmissionapp.DataDummy
import com.example.storysubmissionapp.MainDispatcherRule
...
import com.example.storysubmissionapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<Story> = homeViewModel.stories("test").getOrAwaitValue()
    ...
    fun `when Get Quote Empty Should Return No Data`() = runTest {
        ...
        val actualStory: PagingData<Story> = mainViewModel.stories("test").getOrAwaitValue()
